...
public class MakePlants : MonoBehaviour
{
    ...
    public void setupPlant(Vector3 m_originBranch, int m_type)
    {
        ...
        int tempNumPoints = (int)Random.Range(20, 30);
        ...
        branch.setupPlant(tempControlPointsBranche, fleursIndexPrincipale, feuillesIndex, Color.red, Color.magenta, tempStartWidth, tempEndWidth, tempNumPoints, tempNumControlPoints, tempNumControlPoints * 2, tempGrowingMultiplierM0, tempGrowingMultiplierM1, lineRendererBranch, false, type);
        ...
        for (int i = 0; i < nTiges; i++)
        {
            ...
            int tempNumControlPointsTige = Random.Range(3, 8);
            ...
            tige.setupPlant(tempControlPointsTige, fleursIndexTiges, feuillesIndex,Color.magenta, Color.green, tempStartWidthTige, tempEndWidthTige, tempNumPointsTige, tempNumControlPointsTige, tempNumControlPointsTige * 2, tempGrowingMultiplierM0Tige, tempGrowingMultiplierM1Tige, lineRendererTige, false, type);
    ...
    public List<Vector3> generateControlPoints(TigeControlHierarchie m_mode, int m_numControlPoints, Vector3 m_origin)
    {
        ...
        else if (m_mode == TigeControlHierarchie.SecondaireDroite)
        {
            ...
            Debug.Log("FleursIndexTigesDroite = "+ fleursIndexTiges[0]);
        }
        ...
        else if (m_mode == TigeControlHierarchie.SecondaireGauche)
        {
            ...
            fleursIndexTiges.Add(m_numControlPoints - 2);
            Debug.Log("FleursIndexTigesGauche = " + fleursIndexTiges[0]);
        }
