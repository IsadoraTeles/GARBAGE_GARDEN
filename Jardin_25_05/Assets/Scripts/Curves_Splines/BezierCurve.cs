...
public class BezierCurve : MonoBehaviour
{
    ...
    public Vector3 GetPointQuadratic (float t)
    {
     ...
     // it should not be affected by the position of the curve
    public Vector3 GetVelocityQuadratic (float t)
    {
        return
            transform.TransformPoint(Bezier.GetFirstDerivativeQuadratic(points[0], points[1], points[2], t)) -
            transform.position;
    }
    ...
    */
    ...
    {
        return
            transform.TransformPoint(Bezier.GetFirstDerivativeCubic(points[0], points[1], points[2], points[3], t)) -
            transform.position;
    }
